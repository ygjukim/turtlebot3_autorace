...
{
    ros::init(argc, argv, "image_projection", ros::init_options::AnonymousName);
    ...
    manager.load(ros::this_node::getName(), "turtlebot3_autorace_camera/image_projection", remappings, my_argv);
